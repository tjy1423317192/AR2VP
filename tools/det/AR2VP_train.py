...
#     pdb.set_trace()
    ...
    combined_training_dataset = ConcatDataset([training_dataset1, training_dataset2,training_dataset3])
    ...
    for epoch in range(start_epoch, num_epochs + 1):
        ...
        running_agent0 = AverageMeter("loc_loss_agent0",":.6f")
        ...
        for sample in t:
            ...
            loss, cls_loss, loc_loss,grads_list,m = faf_module.step(
                data, batch_size, m,num_agent=num_agent
            )
#             print(loss_loc_agent_0)
#             pdb.set_trace()
...
if __name__ == "__main__":
    ...
    parser.add_argument("--logpath", default="../begin/det_all/me_bridge", help="The path to the output log file")
    parser.add_argument(
        "--resume",
        default="",
        type=str,
    ...
    parser.add_argument(
        "--auto_resume_path",
        default="../begin/det_all/me_bridge",
        type=str,
